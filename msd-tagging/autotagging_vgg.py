...
if __name__ == "__main__":
    ...
    model_checkpoint = keras.callbacks.ModelCheckpoint(os.path.join(MODELS_PATH, "model_vgg_repr_{}_{}.h5".format(args.bins, args.meluse)), monitor='val_loss', save_best_only=True, mode='max')
