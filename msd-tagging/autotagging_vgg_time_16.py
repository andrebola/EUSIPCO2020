...
def CompactCNN(input_shape, nb_conv, nb_filters, n_mels, normalize, nb_hidden, dense_units,
    ...
    if n_mels >= 256:
        ...
        poolings = [(2, 4), (4, 5), (4, 9), (4, 5), (4, 4)]
    elif n_mels >= 96:
        poolings = [(2, 4), (4, 5), (3, 9), (4, 5), (4, 3)] #(2, 8), (4, 3)]
    elif n_mels >= 72:
        poolings = [(2, 4), (3, 4), (2, 5), (2, 4), (3, 4)]
    elif n_mels >= 64:
        poolings = [(2, 4), (2, 4), (2, 5), (2, 4), (4, 4)]
    elif n_mels >= 48:
        poolings = [(2, 4), (4, 5), (3, 9), (2, 5), (4, 4)]
    elif n_mels >= 32:
...
if __name__ == "__main__":
    ...
    model_checkpoint = keras.callbacks.ModelCheckpoint(os.path.join(MODELS_PATH, "model_vgg_repr_16_{}_time_{}.h5".format(args.bins, args.meluse)), monitor='val_loss', save_best_only=True, mode='max')
