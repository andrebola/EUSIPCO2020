...
def CompactCNN(input_shape, nb_conv, nb_filters, n_mels, normalize, nb_hidden, dense_units,
    ...
    if n_mels >= 256:
        ...
        poolings = [(2, 4), (4, 5), (4, 8), (4, 8), (4, 4)] #50
        if time_res == 2:
            poolings = [(2, 4), (4, 5), (4, 8), (4, 4), (4, 4)] # 100
        if time_res in [3, 4]:
            poolings = [(2, 4), (4, 5), (4, 8), (4, 2), (4, 4)] #200 & 150
        if time_res == 5:
            poolings = [(2, 4), (4, 5), (4, 8), (4, 1), (4, 4)] #250
        if time_res == 10:
            poolings = [(2, 4), (4, 5), (4, 4), (4, 1), (4, 4)] #500
    elif n_mels >= 96:
        poolings = [(2, 4), (4, 5), (3, 8), (4, 8), (4, 4)] # 50
        if time_res == 2:
            poolings = [(2, 4), (4, 5), (3, 8), (4, 4), (4, 3)] #100
        if time_res in [3, 4]:
            poolings = [(2, 4), (4, 5), (3, 8), (4, 2), (4, 3)] #200 & 150
        if time_res == 5:
            poolings = [(2, 4), (4, 5), (3, 8), (4, 1), (4, 3)] #250
        if time_res == 10:
            poolings = [(2, 4), (4, 5), (3, 4), (4, 1), (4, 3)] # 500
    elif n_mels >= 48:
        poolings = [(2, 4), (4, 5), (3, 8), (2, 8), (4, 4)] # 50
        if time_res == 2:
            poolings = [(2, 4), (4, 5), (3, 8), (2, 4), (4, 3)] #100
        if time_res in [3, 4]:
            poolings = [(2, 4), (4, 5), (3, 8), (2, 2), (4, 3)] #200 & 150
        if time_res == 5:
            poolings = [(2, 4), (4, 5), (3, 8), (2, 1), (4, 3)] #250
        if time_res == 10:
            poolings = [(2, 4), (4, 5), (3, 4), (2, 1), (4, 3)] # 500
    elif n_mels >= 32:
    ...
    for melbands in ['mel128_log', 'mel96_log', 'mel48_log', 'mel128', 'mel96', 'mel48']:
        for time_red in [5,10,4,2,3]:
            ...
            history = model.fit(data_train[:,:,::time_red,:], classes_train,
                        ...
                        epochs=epochs,
                        callbacks=callbacks+[TestCallback(data_test[:,:,::time_red,:], classes_test, data_val[:,:,::time_red,:], classes_val, data_train[:,:,::time_red,:], classes_train, "{}_{}".format(melbands, str(50*time_red)))]
                        )
